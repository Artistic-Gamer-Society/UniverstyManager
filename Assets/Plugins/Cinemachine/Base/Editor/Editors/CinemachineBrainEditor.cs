...
namespace Cinemachine.Editor
{
    ...
    internal sealed class CinemachineBrainEditor : BaseEditor<CinemachineBrain>
    {
        ...
        static class InstallGizmos
        {
            ...
            {
                string srcFile = ScriptableObjectUtility.CinemachineInstallPath + "Plugins/Cinemachine/Gizmos/" + kGizmoFileName;
                if (File.Exists(srcFile))
                {
                    string dstFile = Application.dataPath + "Plugins/Cinemachine/Gizmos";
